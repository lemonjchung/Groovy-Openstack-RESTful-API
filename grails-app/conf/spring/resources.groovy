...
import com.netflix.asgard.auth.UserLoginAuthenticationProvider
import com.netflix.asgard.auth.UserLoginAuthorizationProvider
...
import com.serve.asgard.model.AsgardUserContext
...
beans = {
    ...
    if (application.config.plugin?.authenticationProvider == 'userLoginAuthenticationProvider') {
        userLoginAuthenticationProvider(UserLoginAuthenticationProvider) { bean ->
            bean.lazyInit = true
        }
    }
    ...
    userLoginAuthorizationProvider(UserLoginAuthorizationProvider) { bean ->
        bean.lazyInit = true
    }
    ...
    asgardUserContextBean(AsgardUserContext) { bean ->
    bean.scope = 'session'
  }

  asgardUserContextService(ScopedProxyFactoryBean) {
      targetBeanName = 'asgardUserContextBean'
