...
appDatabase {
  mongo{
    connectionString = "mongodb://localhost:27017/applications"
  }
}
...
log4j = {
    ...
    appenders {
        ...
        def logDirectory = "/var/log/asgard"
        ...
        rollingFile name: "stacktrace", maxFileSize: 50000000,
                file: "${logDirectory}/stacktrace.log", maxBackupIndex: 10
    }

    root {
      debug 'asgardrolling','stdout'
    }
    ...
    debug 'com.serve.asgard'
    debug 'com.netflix.asgard.AutoScalingController'
...
templateHome = "web-app/ostemplates/"
...
cloud {
	...
	// Disabled AWS Connection and Functions
